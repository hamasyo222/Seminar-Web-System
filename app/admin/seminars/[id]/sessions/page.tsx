...
export default async function SessionsPage({
  ...
  const seminar = await getSeminarWithSessions(id)
  ...
  return (
    <div>
      ...
      <div className="flex justify-between items-start mb-8">
        ...
        <Link
          href={`/admin/seminars/${id}/sessions/new`}
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 space-y-1 text-sm text-gray-600">
                      ...
                      <p>
                        定員: {session.capacity}名（申込: {session._count.orders}件）
                      </p>
                      {session.zoomType && (
                        <p>
                  ...
                  <div className="flex space-x-2">
                    <Link
                      href={`/admin/seminars/${id}/sessions/${session.id}/edit`}
                ...
                {session.ticketTypes.length > 0 && (
                  <div className="mt-6 border-t pt-4">
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <Link
                        href={`/admin/seminars/${id}/sessions/${session.id}/tickets`}
